...
namespace EduGame {
	...
	/// <summary>
	/// Summary for JeopardyGameBoardForm
	/// </summary>
	public ref class JeopardyGameBoardForm : public System::Windows::Forms::Form
	{
	public:
		JeopardyGameBoardForm(JeopardyGame *gameObj, CStudent *stu)
		...
		JeopardyGameBoardForm(JeopardyGame *gameObj, CAssessment *stuAssess)
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->Name = L"JeopardyGameBoardForm";
			this->Text = L"JeopardyGameBoardForm";
